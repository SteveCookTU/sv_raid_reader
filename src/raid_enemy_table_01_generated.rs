...
pub enum RaidEnemyTable01Offset {}
#[derive(Copy, Clone, PartialEq)]

pub struct RaidEnemyTable01<'a> {
    pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for RaidEnemyTable01<'a> {
    type Inner = RaidEnemyTable01<'a>;
    #[inline]
    unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
        Self {
            _tab: flatbuffers::Table::new(buf, loc),
...
impl<'a> RaidEnemyTable01<'a> {
    pub const VT_RAIDENEMYINFO: flatbuffers::VOffsetT = 4;

    #[inline]
    pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
        RaidEnemyTable01 { _tab: table }
    }
    #[allow(unused_mut)]
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args RaidEnemyTable01Args<'args>,
    ) -> flatbuffers::WIPOffset<RaidEnemyTable01<'bldr>> {
        let mut builder = RaidEnemyTable01Builder::new(_fbb);
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<RaidEnemyInfo>>(
                    RaidEnemyTable01::VT_RAIDENEMYINFO,
                    None,
                )
                .unwrap()
        }
...
impl flatbuffers::Verifiable for RaidEnemyTable01<'_> {
    #[inline]
    fn run_verifier(
        v: &mut flatbuffers::Verifier,
        pos: usize,
...
pub struct RaidEnemyTable01Args<'a> {
    pub raidEnemyInfo: Option<flatbuffers::WIPOffset<RaidEnemyInfo<'a>>>,
}
impl<'a> Default for RaidEnemyTable01Args<'a> {
    #[inline]
    fn default() -> Self {
        RaidEnemyTable01Args {
            raidEnemyInfo: None,
        }
    }
}

pub struct RaidEnemyTable01Builder<'a: 'b, 'b> {
    fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> RaidEnemyTable01Builder<'a, 'b> {
    #[inline]
    ...
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    ) -> RaidEnemyTable01Builder<'a, 'b> {
        let start = _fbb.start_table();
        RaidEnemyTable01Builder {
            fbb_: _fbb,
            start_: start,
        }
    }
    #[inline]
    pub fn finish(self) -> flatbuffers::WIPOffset<RaidEnemyTable01<'a>> {
        let o = self.fbb_.end_table(self.start_);
        flatbuffers::WIPOffset::new(o.value())
    }
}

impl core::fmt::Debug for RaidEnemyTable01<'_> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let mut ds = f.debug_struct("RaidEnemyTable01");
        ds.field("raidEnemyInfo", &self.raidEnemyInfo());
        ds.finish()
    }
}
pub enum RaidEnemyTable01ArrayOffset {}
#[derive(Copy, Clone, PartialEq)]

pub struct RaidEnemyTable01Array<'a> {
    pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for RaidEnemyTable01Array<'a> {
    type Inner = RaidEnemyTable01Array<'a>;
    #[inline]
    unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
        Self {
            _tab: flatbuffers::Table::new(buf, loc),
...
impl<'a> RaidEnemyTable01Array<'a> {
    pub const VT_VALUES: flatbuffers::VOffsetT = 4;

    #[inline]
    pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
        RaidEnemyTable01Array { _tab: table }
    }
    #[allow(unused_mut)]
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args RaidEnemyTable01ArrayArgs<'args>,
    ) -> flatbuffers::WIPOffset<RaidEnemyTable01Array<'bldr>> {
        let mut builder = RaidEnemyTable01ArrayBuilder::new(_fbb);
    ...
    pub fn values(
        &self,
    ) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RaidEnemyTable01<'a>>> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RaidEnemyTable01>>,
                >>(RaidEnemyTable01Array::VT_VALUES, None)
                .unwrap()
        }
    }
}

impl flatbuffers::Verifiable for RaidEnemyTable01Array<'_> {
    #[inline]
    fn run_verifier(
        v: &mut flatbuffers::Verifier,
        pos: usize,
        ...
        v.visit_table(pos)?
            .visit_field::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<RaidEnemyTable01>>,
            >>("values", Self::VT_VALUES, false)?
            .finish();
        Ok(())
    }
}
pub struct RaidEnemyTable01ArrayArgs<'a> {
    pub values: Option<
...
impl<'a> Default for RaidEnemyTable01ArrayArgs<'a> {
    #[inline]
    fn default() -> Self {
        RaidEnemyTable01ArrayArgs { values: None }
    }
}

pub struct RaidEnemyTable01ArrayBuilder<'a: 'b, 'b> {
    fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> RaidEnemyTable01ArrayBuilder<'a, 'b> {
    #[inline]
    pub fn add_values(
        &mut self,
        values: flatbuffers::WIPOffset<
            flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<RaidEnemyTable01<'b>>>,
        >,
    ) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            RaidEnemyTable01Array::VT_VALUES,
            values,
        );
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    ) -> RaidEnemyTable01ArrayBuilder<'a, 'b> {
        let start = _fbb.start_table();
        RaidEnemyTable01ArrayBuilder {
            fbb_: _fbb,
            start_: start,
        }
    }
    #[inline]
    pub fn finish(self) -> flatbuffers::WIPOffset<RaidEnemyTable01Array<'a>> {
        let o = self.fbb_.end_table(self.start_);
        flatbuffers::WIPOffset::new(o.value())
    }
}

impl core::fmt::Debug for RaidEnemyTable01Array<'_> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let mut ds = f.debug_struct("RaidEnemyTable01Array");
...
#[inline]
/// Verifies that a buffer of bytes contains a `RaidEnemyTable01Array`
/// and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_raid_enemy_table_01_array_unchecked`.
pub fn root_as_raid_enemy_table_01_array(
    buf: &[u8],
) -> Result<RaidEnemyTable01Array, flatbuffers::InvalidFlatbuffer> {
    flatbuffers::root::<RaidEnemyTable01Array>(buf)
}
#[inline]
/// Verifies that a buffer of bytes contains a size prefixed
/// `RaidEnemyTable01Array` and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `size_prefixed_root_as_raid_enemy_table_01_array_unchecked`.
pub fn size_prefixed_root_as_raid_enemy_table_01_array(
    buf: &[u8],
) -> Result<RaidEnemyTable01Array, flatbuffers::InvalidFlatbuffer> {
    flatbuffers::size_prefixed_root::<RaidEnemyTable01Array>(buf)
}
#[inline]
/// Verifies, with the given options, that a buffer of bytes
/// contains a `RaidEnemyTable01Array` and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_raid_enemy_table_01_array_unchecked`.
pub fn root_as_raid_enemy_table_01_array_with_opts<'b, 'o>(
    opts: &'o flatbuffers::VerifierOptions,
    buf: &'b [u8],
) -> Result<RaidEnemyTable01Array<'b>, flatbuffers::InvalidFlatbuffer> {
    flatbuffers::root_with_opts::<RaidEnemyTable01Array<'b>>(opts, buf)
}
#[inline]
/// Verifies, with the given verifier options, that a buffer of
/// bytes contains a size prefixed `RaidEnemyTable01Array` and returns
/// it. Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_raid_enemy_table_01_array_unchecked`.
pub fn size_prefixed_root_as_raid_enemy_table_01_array_with_opts<'b, 'o>(
    opts: &'o flatbuffers::VerifierOptions,
    buf: &'b [u8],
) -> Result<RaidEnemyTable01Array<'b>, flatbuffers::InvalidFlatbuffer> {
    flatbuffers::size_prefixed_root_with_opts::<RaidEnemyTable01Array<'b>>(opts, buf)
}
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a RaidEnemyTable01Array and returns it.
/// # Safety
/// Callers must trust the given bytes do indeed contain a valid `RaidEnemyTable01Array`.
pub unsafe fn root_as_raid_enemy_table_01_array_unchecked(buf: &[u8]) -> RaidEnemyTable01Array {
    flatbuffers::root_unchecked::<RaidEnemyTable01Array>(buf)
}
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a size prefixed RaidEnemyTable01Array and returns it.
/// # Safety
/// Callers must trust the given bytes do indeed contain a valid size prefixed `RaidEnemyTable01Array`.
pub unsafe fn size_prefixed_root_as_raid_enemy_table_01_array_unchecked(
    buf: &[u8],
) -> RaidEnemyTable01Array {
    flatbuffers::size_prefixed_root_unchecked::<RaidEnemyTable01Array>(buf)
}
#[inline]
pub fn finish_raid_enemy_table_01_array_buffer<'a, 'b>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    root: flatbuffers::WIPOffset<RaidEnemyTable01Array<'a>>,
) {
    fbb.finish(root, None);
}

#[inline]
pub fn finish_size_prefixed_raid_enemy_table_01_array_buffer<'a, 'b>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    root: flatbuffers::WIPOffset<RaidEnemyTable01Array<'a>>,
) {
